...
{% set columns = ['goals_per_game_rank', 'shots_per_game_rank', 'p1_shots_per_game_rank', 'p2_shots_per_game_rank', 'p3_shots_per_game_rank', 
'p1_goals_rank', 'p2_goals_rank', 'p3_goals_rank', 'ot_goals_rank', 'ot_shots_rank', 'pp_goals_rank', 'pp_attempts_rank', 'pp_pct_rank',
'pim_per_game_rank', 'hits_per_game_rank', 'blocks_per_game_rank', 'takeaways_per_game_rank', 'giveaways_per_game_rank'] %}
